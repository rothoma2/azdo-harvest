...
class FileDownloader:
    ...
    def download_file(
        ...
        Args:
            ...
            preserve_structure: If True, preserve the repository path structure
            custom_filename: Optional custom filename (overrides preserve_structure)
        ...
        try:
            ...
            if custom_filename:
                ...
                # Create directory structure: repo/path/to/file
                file_path = base_path / file_result.repository / file_result.filepath.lstrip('/')
            else:
                # Just save the file with its name
            ...
            raise Exception(f"Failed to download {file_result.filepath}: {str(e)}")
    ...
    def get_file_content(self, file_result: FileResult) -> str:
        ...
        try:
            ...
            raise Exception(f"Failed to get content for {file_result.filepath}: {str(e)}")
